...
class CoffeeMachine(FSMGenerator):
    ...
    def __init__(self):
        ...
        self.outputs = ["✔️", "☕", "✖️"]
        self.transitions = [
            {"trigger": "C / ✔️", "source": "S0", "dest": "S0"},
            {"trigger": "B / ✖️", "source": "S0", "dest": "S5"},
            {"trigger": "P / ✔️", "source": "S0", "dest": "S1"},
            {"trigger": "W / ✔️", "source": "S0", "dest": "S2"},
            {"trigger": "P / ✔️", "source": "S1", "dest": "S1"},
            {"trigger": "C / ✔️", "source": "S1", "dest": "S0"},
            {"trigger": "B / ✖️", "source": "S1", "dest": "S5"},
            {"trigger": "W / ✔️", "source": "S1", "dest": "S3"},
            {"trigger": "C / ✔️", "source": "S3", "dest": "S0"},
            {"trigger": "B / ☕", "source": "S3", "dest": "S4"},
            {"trigger": "C / ✔️", "source": "S4", "dest": "S0"},
            {"trigger": "C / ✔️", "source": "S2", "dest": "S0"},
            {"trigger": "W / ✔️", "source": "S3", "dest": "S3"},
            {"trigger": "P / ✔️", "source": "S3", "dest": "S3"},
            {"trigger": "W / ✔️", "source": "S2", "dest": "S2"},
            {"trigger": "P / ✔️", "source": "S2", "dest": "S3"},
            {"trigger": "B / ✖️", "source": "S4", "dest": "S5"},
            {"trigger": "P / ✖️", "source": "S4", "dest": "S5"},
            {"trigger": "W / ✖️", "source": "S4", "dest": "S5"},
            {"trigger": "B / ✖️", "source": "S2", "dest": "S5"},
            {"trigger": "C / ✖️", "source": "S5", "dest": "S5"},
            {"trigger": "B / ✖️", "source": "S5", "dest": "S5"},
            {"trigger": "P / ✖️", "source": "S5", "dest": "S5"},
            {"trigger": "W / ✖️", "source": "S5", "dest": "S5"},
            {"trigger": "R / ✔️", "source": "S5", "dest": "S0"},
        ]
